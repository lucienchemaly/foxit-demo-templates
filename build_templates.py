"""
Build the two Word templates referenced by article1-writing.md and verify them
against the Foxit DocGen API.

Outputs:
  - invoice_simple.docx   (scalar tokens only: welcome / first-run friendly)
  - invoice_table.docx    (full invoice with line-items loop, matches article payload)
  - invoice_simple_test.pdf and invoice_table_test.pdf (rendered proof)
"""
import base64
import os
import sys
